...
public abstract class DbxEntry extends Dumpable implements Serializable
{
    ...
    /**
     * whether this file or folder is deleted or not
     * added by CHO
     */
     ...
     */
    private DbxEntry(String path, String iconName, boolean mightHaveThumbnail, boolean isDeleted)
    {
    ...
    public static final class Folder extends DbxEntry
    {
         ...
         * @param mightHaveThumbnail {@link #mightHaveThumbnail}
         */
        public Folder(String path, String iconName, boolean mightHaveThumbnail, boolean isDeleted)
        {
            super(path, iconName, mightHaveThumbnail, isDeleted);
        }
    ...
    public static final class File extends DbxEntry
    {
        ...
        /**
         * 	The mime-type of the file at this path
         * 	added by CHO
         */
         ...
         * @param is_deleted 
         */
        public File(String path, String iconName, boolean mightHaveThumbnail, long numBytes, String humanSize, Date lastModified, Date clientMtime, String rev, boolean isDeleted, String mimeType)
        {
            super(path, iconName, mightHaveThumbnail, isDeleted);
        ...
        throws IOException, JsonReadException
    {
        ...
        DbxEntry e;
        if (is_dir) {
            e = new Folder(path, icon, thumb_exists, is_deleted);
        }
        else {
            // Normal File
            ...
            e = new File(path, icon, thumb_exists, bytes, size, modified, client_mtime, rev, is_deleted, mime_type);
        }
